...
r["default"])(this).data("ga-label");f("send","event",{eventCategory:n,eventAction:t,eventLabel:o,transport:"beacon"})}),t.on("submit",function(t){t.preventDefault();var n=!1,o="Fields marked with (*) are required";return""==(0,r["default"])(".copaair-form-name").val()&&(n=!0),""==(0,r["default"])(".copaair-form-lastname").val()&&(n=!0),""==(0,r["default"])("copaair-form-email").val()&&(n=!0),""==(0,r["default"])(".js-country-selector").val()&&(n=!0),""==(0,r["default"])(".js-city-selector").val()&&(n=!0),""==(0,r["default"])(".js-signup-date").val()&&(n=!0),n?(alert(o),!1):(e.submitForm(t.target),void(0,r["default"])(".copaair-signup")[0].reset())}),(0,r["default"])(".js-country-selector").selectmenu({change:function(e,t){this.options.country=t.item.value;var n=store.get("destinations"),o=[];for(var i in n.val)n.val[i].country===this.options.country&&o.push(n.val[i]);new d["default"]({lang:this.options.lang,data:o,selector:(0,r["default"])(".js-city-selector")}),(0,r["default"])(".js-city-selector").selectmenu("refresh")}}),(0,r["default"])(".js-city-selector").selectmenu({change:function(e,t){this.options.city=t.item.value}})}},{key:"submitForm",value:function(e){var t=(0,r["default"])(e),n=t.serializeObject();n.fullname=n.first_name+" "+n.last_name,n.source=this.options.source,n.language=this.options.lang.toUpperCase(),n.city=this.options.city,n.country=this.options.country;this.options.container;r["default"].ajax({data:n,type:"POST",url:"https://flightcontrol.io/api/signup/add"}).done(function(){(0,r["default"])(".copaair-widget-hidden").fadeOut(),(0,r["default"])(".copaair-signup-message").delay(400).fadeIn();var e={EN:"You have successfully subscribed to our mailing list",PT:"Você foi inscrito com sucesso em nossa lista de endereços",ES:"Ya estás registrado correctamente en nuestra lista de correo"};(0,r["default"])(".copaair-signup-message").text(e[n.language]||e.EN),f("send","event",{eventCategory:"Subscription Form",eventAction:"success",eventLabel:"User was subscribed",transport:"beacon"})})}}]),e}();n["default"]=h}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"../lib/DataMenu":7,"../lib/Template":11,"store-js":1}]},{},[5]);
>>>>>>> f3c799eda661d9fda7f3cf08611fd46692deff9b
